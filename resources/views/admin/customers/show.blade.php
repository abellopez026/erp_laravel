                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <p class="text-muted text-center">Cliente frecuente</p>

                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Correo:</b> <a class="float-right">{{ $customer->email }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Telefono:</b> <a class="float-right">{{ $customer->phone }}</a>
                                </li>
                            </ul>

                            <a href="#" class="btn btn-primary btn-block"><b>Ver detalles de compras</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <h3 class="timeline-header border-0"><a
                                                        href="#">{{ $customer->name }}</a> realizo una compra
                                                </h3>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="{{ route('customers.update', $customer) }}"
                                        method="POST">
                                        @method('PUT')
                                        @csrf
